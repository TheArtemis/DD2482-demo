...
The app and a separate `/logs` page are served by Nginx. `/logs` shows release fetches and deployment output, and remains available during the outage. See the [walkthrough](blue-green-demo/demo.md) for exact steps.
