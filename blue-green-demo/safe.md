...
**Result:** The app still returns **HTTP 200** and shows v1. [The deployment log]({{TRAFFIC_HOST1_80}}/logs) shows the rejected candidate even though the unit tests pass.
