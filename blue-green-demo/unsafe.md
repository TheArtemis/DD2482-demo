...
**Result:** The app returns **HTTP 502**. [The deployment log]({{TRAFFIC_HOST1_80}}/logs) shows the failure. GitHub Actions stays green because the unit tests verify both healthy and broken responses; they do not approve a release for live traffic.
